...
export const enUS: Dict = {
  ...
  protocolBlocking: 'Ingress protocol blocking',
  blockHttp: 'Block HTTP',
  blockTls: 'Block TLS',
  blockTlsHint: 'Best-effort detection of a TLS ClientHello at the start of a connection. Delayed sends, STARTTLS, QUIC, and nested TLS may bypass it; unknown traffic is allowed.',
  blockProtocolHint: 'Best-effort detection of a plaintext HTTP request line or TLS ClientHello at the start of a connection. Delayed sends, STARTTLS, QUIC, nested traffic, and unknown traffic are allowed.',
  httpBlocked: 'HTTP blocked',
  tlsBlocked: 'TLS blocked',
  blockedHttpConnections: 'HTTP rejects',
  blockedTlsConnections: 'TLS rejects',
  blockedSinceNodeStart: 'Rejects since this node process started',
  ...
  planGrantTunnels: 'Granted Tunnels',
