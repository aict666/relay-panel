...
export const enUS: Dict = {
  ...
  chainHopsHint: 'Select at least an entry and exit',
  addHop: 'Add hop',
  hopEntry: 'Entry',
  hopMid: 'Mid',
  hopExit: 'Exit',
  ...
  tunnelSelectHint: 'Select a preset tunnel',
  ...
  maxConnections: 'Max connections per node (0 = unlimited)',
  autoRestart: 'Auto-restart interval (0 = off)',
  ...
  planTraffic: 'Traffic',
  planTrafficGb: 'Traffic (GB, 0 = unlimited)',
  planMaxRules: 'Max Rules',
  planDuration: 'Duration (days)',
  planDurationHint: 'At least 1 day',
  planPrice: 'Price',
  planHidden: 'Hidden',
  planResetTraffic: 'Reset used traffic on purchase',
