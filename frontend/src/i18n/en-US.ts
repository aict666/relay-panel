...
export const enUS: Dict = {
  ...
  dashboardNetworkTrendHint: 'Bandwidth comes from each online node’s monitored NIC and includes SSH, system updates, and other non-RelayPanel traffic. Connections use the peak in each aggregated bucket.',
